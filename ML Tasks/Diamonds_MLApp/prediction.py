...
def show_predict_page():
    original_title = '<p style="font-family:cursive; color:black; font-size: 60px;">Diamond Price Prediction</p>'
    st.markdown(original_title, unsafe_allow_html=True)
    #st.title("Diamond Price Prediction")
    original_title1 = '<p style="font-family:cursive; color:black; font-size: 30px;">We need some information for price prediction</p>'
